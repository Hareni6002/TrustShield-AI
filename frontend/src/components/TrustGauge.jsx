...
export default function TrustGauge({ score, onComplete }) {
  ...
  return <main className="gauge-screen">
    ...
    <div className="gauge-wrap">
      <svg className="gauge-svg" viewBox="0 0 320 180" role="img" aria-label={`Trust score ${score} out of 100`}><defs><linearGradient id="riskGradient" x1="0" x2="1"><stop offset="0" stopColor="#c32632" /><stop offset="0.5" stopColor="#c07b3a" /><stop offset="1" stopColor="#65a66d" /></linearGradient></defs><path d="M 30 160 A 130 130 0 0 1 290 160" fill="none" stroke="#2b171a" strokeWidth="18" strokeLinecap="round" /><path d="M 30 160 A 130 130 0 0 1 290 160" fill="none" stroke="url(#riskGradient)" strokeWidth="4" strokeLinecap="round" /></svg>
